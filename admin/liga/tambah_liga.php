...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($errors)) {
        ...
        if (empty($errors)) {
            $query = "INSERT INTO liga (ID_LIGA, NAMA_LIGA, LOGO)
                     VALUES ('$id_liga', '$nama_liga', " . 
                     ($logo_name ? "'$logo_name'" : "NULL") . ")";
            
            if (mysqli_query($conn, $query)) {
                $success = "Liga \"$nama_liga\" berhasil ditambahkan!";
                // Reset form
                $_POST = [];
            } else {
                $error = "Gagal menambah liga: " . mysqli_error($conn);
            }
        } else {
            $error = implode("<br>", $errors);
        }
...
<head>
    ...
    <title>Tambah Liga - Admin KickOff</title>
...
<body>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="form-section">
                        <h1 class="page-title">
                            <i class="bi bi-plus-circle me-2"></i>Tambah Liga
                        </h1>
                        <p class="page-subtitle">Tambahkan liga baru ke dalam database KickOff</p>
                            ...
                            <div class="alert alert-success">
                                ...
                                <div class="mt-2">
                                    <a href="daftar_liga.php" class="btn btn-light btn-sm">
                                        <i class="bi bi-list me-1"></i>Lihat Daftar Liga
                                    </a>
                                    <button type="button" class="btn btn-outline-light btn-sm ms-2" onclick="location.reload()">
                                        <i class="bi bi-plus me-1"></i>Tambah Liga Lagi
                                    </button>
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="info-box">
                            ...
                            <ul>
                                <li><strong>ID Liga:</strong> Harus 5 karakter unik (contoh: LIG01)</li>
                                <li><strong>Nama Liga:</strong> Nama resmi liga sepakbola</li>
                                <li><strong>Logo:</strong> Format JPG/PNG/GIF/SVG, maksimal 5MB (opsional)</li>
                            </ul>
                        </div>
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            <div class="mb-4">
                                <label for="id_liga" class="form-label">
                                    <i class="bi bi-hash me-1"></i>ID Liga
                                ...
                                <input type="text" class="form-control" id="id_liga" name="id_liga" required 
                                       ...
                                       value="<?php echo isset($_POST['id_liga']) ? htmlspecialchars($_POST['id_liga']) : ''; ?>">
                                <div class="helper-text">5 karakter unik untuk mengidentifikasi liga</div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="nama_liga" name="nama_liga" required 
                                       ...
                                       value="<?php echo isset($_POST['nama_liga']) ? htmlspecialchars($_POST['nama_liga']) : ''; ?>">
    ...
    <script>
        ...
        // Auto uppercase for ID Liga
        document.getElementById('id_liga').addEventListener('input', function(e) {
            e.target.value = e.target.value.toUpperCase();
        });

        // Form validation
        document.querySelector('form').addEventListener('submit', function(e) {
            const idLiga = document.getElementById('id_liga').value;
            const namaLiga = document.getElementById('nama_liga').value;

            if (idLiga.length !== 5) {
                alert('ID Liga harus 5 karakter!');
                e.preventDefault();
                return;
            }
